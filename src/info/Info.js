...
export const info = {
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        ...
        {
            emoji: '🌎',
            text: 'based in the Malaysia'
        },
        {
            emoji: "💼",
            text: "Frontend Developer at DPO International"
        },
        {
            emoji: "📧",
...
// Just change the links so that they lead to your social profiles.
    ...
    bio: "Hello! I'm Naim. I'm a frontend developer for DPO International. I studied Software Engineering at UPSI, I enjoy long walks at the park, and I believe artificial intelligence will inevitably rule us all one day. You should hire me!",
    skills:
        {
            proficientWith: ['javascript', 'wordpress', 'laravel', 'react', 'git', 'github', 'bootstrap', 'html5', 'css3', 'php' ],
            exposedTo: ['nodejs', '.Net 7']
        }
    ,
    hobbies: [
        {
